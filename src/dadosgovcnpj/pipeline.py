...
def build_final_dataset(spark: SparkSession, config: PipelineConfig) -> DataFrame:
    ...
    jucees = (
        ...
        .withColumnRenamed("logradouro", "jucees_logradouro")
        .withColumnRenamed("numero", "jucees_numero")
        .withColumnRenamed("complemento", "jucees_complemento")
        .withColumnRenamed("bairro", "jucees_bairro")
        .withColumnRenamed("cep", "jucees_cep")
        .withColumnRenamed("cod_natureza_juridica", "jucees_cod_natureza_juridica")
